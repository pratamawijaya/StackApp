...
public class QuestionAdapter extends RecyclerView.Adapter<QuestionAdapter.QuestionHolder> {
  ...
  @Override public QuestionHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view =
        LayoutInflater.from(parent.getContext()).inflate(R.layout.view_question, parent, false);
    view.setOnClickListener(mOnClick);
    return new QuestionHolder(view);
  }

  @Override public void onBindViewHolder(QuestionHolder holder, int position) {
  ...
  private final View.OnClickListener mOnClick = new View.OnClickListener() {
    @Override public void onClick(View v) {
      ...
      data.putParcelable("data", q);
      context.startActivity(new Intent(context, DetailActivity.class).putExtras(data));
    }
  };
